...
class TestCard(unittest.TestCase):
    def test_available_actions(self):
        ...
        self.assertIn(Action.BUY, stock_card.get_available_actions(player))
        self.assertNotIn(Action.SELL, stock_card.get_available_actions(player))
        self.assertIn(Action.SKIP, stock_card.get_available_actions(player))
        ...
        self.assertNotIn(Action.BUY, stock_card.get_available_actions(player))
        self.assertNotIn(Action.SELL, stock_card.get_available_actions(player))
        self.assertIn(Action.SKIP, stock_card.get_available_actions(player))
        ...
        self.assertIn(Action.BUY, stock_card.get_available_actions(player))
        self.assertIn(Action.SELL, stock_card.get_available_actions(player))
        self.assertIn(Action.SKIP, stock_card.get_available_actions(player))
        ...
        self.assertIn(Action.BUY, property_card.get_available_actions(player))
        self.assertNotIn(Action.SELL, property_card.get_available_actions(player))
        self.assertIn(Action.SKIP, property_card.get_available_actions(player))
        ...
        self.assertNotIn(Action.BUY, property_card.get_available_actions(player))
        self.assertNotIn(Action.SELL, property_card.get_available_actions(player))
        self.assertIn(Action.SKIP, property_card.get_available_actions(player))
        ...
        self.assertIn(Action.BUY, business_card.get_available_actions(player))
        self.assertNotIn(Action.SELL, business_card.get_available_actions(player))
        self.assertIn(Action.SKIP, business_card.get_available_actions(player))
        ...
        self.assertNotIn(Action.BUY, business_card.get_available_actions(player))
        self.assertNotIn(Action.SELL, business_card.get_available_actions(player))
        self.assertIn(Action.SKIP, business_card.get_available_actions(player))
